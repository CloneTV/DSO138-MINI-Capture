...
parser = optparse.OptionParser(
    ...
    description = "DS138-plot.py - capture DSO138 data."
)
...
if options.printWS:
    ...
    try:
        ...
        print("For DSO138 firmware 111 and newer ONLY")
    except:
...
if options.printWS:  # Python 2/3 OK
    ...
    # produce csv file
    fname = "dso138-data.csv"
    if options.filename:
        fname = options.filename
    if options.verbose:
        print("DSO138 csv file: " + fname)
    f = open(fname, "w")
...
if options.data:  # Python 2/3 OK
    ...
    f.close()
    print("Call GNUPlot")
    status = call(['gnuplot', 'DSO138_gnuplot.par'])
